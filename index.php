...
<head>
	<title>Analytttics - Unofficial Dribbble Activity Ratings</title>
	<meta charset="UTF-8">
	<meta name="robots" content="noodp"/>
	<meta name="description" content="Evaluate your Dribbble activities beyond followers counts"/>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
	
	<link rel="stylesheet" rev="stylesheet" href="main.css" type="text/css" media="all" />
	
	<script type="text/javascript" src="js/jquery-3.1.1.min.js"></script>
	<script type="text/javascript" src='js/jribbble.min.js'></script>	
	<script type="text/javascript" src="js/d3.min.js"></script>
	<script type="text/javascript" src="js/main.js"></script>
	<script type="text/javascript" src='js/social-share.min.js'></script>
	
	<link rel="shortcut icon" href="favicon.png" />
	<link href="https://fonts.googleapis.com/css?family=Montserrat:100,400,700&amp;subset=latin-ext" rel="stylesheet">
	
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Analytttics - Unofficial Dribbble Activity Ratings" />
	<meta property="og:description" content="Evaluate your Dribbble activities beyond followers counts" />
	<meta property="og:url" content="http://Anyway.Design/analytttics/" />
	<meta property="og:site_name" content="Analytttics" />
	<meta property="og:image" content="http://Anyway.Design/analytttics/preview.png" />
	
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:description" content="Evaluate your Dribbble activities beyond followers counts" />
	<meta name="twitter:title" content="Analytttics - Unofficial Dribbble Activity Ratings" />
	<meta name="twitter:site" content="@anyway__fm" />
	<meta name="twitter:image" content="http://Anyway.Design/analytttics/preview.png" />
...
<body>
	<div class="home<?php if ($_GET['n']) {echo(' hide');}?>">
		<div class="inner v-align">
			...
			<div class="tagline">Evaluate your Dribbble activities beyond followers counts</div>
			<form class="submit-form" action="" method="get">
				<input type="text" name="n" value="Type Dribbble username to start, or you can try ‘jjying’" class="input-box" onFocus="this.value='';$('.input-box').css('color','#444');"/><input type="submit" value="GO" class="btn"/>
			</form>
		</div>
	...
	<header class="<?php if ($_GET['n']=='') {echo('hide');}?>">
		...
		<form class="v-align submit-form" action="" method="get">
			<input type="text" name="n" value="Type Dribbble username to start" class="input-box" onFocus="this.value='';$('.input-box').css('color','#aaa');"/>
	...
	<main class="<?php if ($_GET['n']=='') {echo('hide');}?>">
		<section class="responsive score">
			<div class="responsive profile">
				...
				<div class="profile-total">
					<div class="inner v-align">
						...
						<h3>Total Score</h3>
						<div class="score-desc">Based on the 5 metrics below.</div>
					</div>
				</div>
			</div>
			<div class="responsive sub-scores diligence">
				<div class="inner v-align">
					...
					<h3 class="diligence-title">Diligence</h3>
					<div class="score-desc">Shots per month</div>
				</div>
			</div>
			...
			<div class="responsive sub-scores attractions">
				<div class="inner v-align">
					...
					<h3 class="attractions-title">Attractions</h3>
					<div class="score-desc">Active follower rate</div>
				</div>
			</div>
			...
			<div class="responsive sub-scores influence">
				<div class="inner v-align">
					...
					<h3 class="influence-title">Influence</h3>
					<div class="score-desc">Followers per month</div>
				</div>
			</div>
			...
			<div class="responsive sub-scores appreciation">
				<div class="inner v-align">
					...
					<h3 class="appreciation-title">Appreciation</h3>
					<div class="score-desc">Fav & bucket rate</div>
				</div>
			</div>
			...
			<div class="responsive sub-scores engagement">
				<div class="inner v-align">
					...
					<div class="score-desc">Comments rate</div>
				</div>
			</div>
		</section>			
		...
		<section class="responsive chart-share">
			...
			<div class="responsive share">
					<div class="social-share" data-initialized="true" data-title="Check out my Dribbble rating on #Analytttics" data-description="Evaluate your Dribbble activities beyond followers counts" data-image="http://Anyway.Design/analytttics/preview.png">
					    <a href="#" class="social-share-icon icon-twitter"><span class="v-align">Share on Twitter</span></a>
					    <a href="#" class="social-share-icon icon-facebook	"><span class="v-align">Like on Facebook</span></a>
					</div>
			</div>
		</section>
		
		<section class="mobile-input">
			<h2>Get your own <span class="mobile-only"><br /></span>Dribbble rating:</h2>
			<form class="submit-form" action="" method="get">
				<input type="text" name="n" value="" class="input-box"/><input type="submit" value="GO" class="btn"/>
			</form>
		</section>
	</main>
