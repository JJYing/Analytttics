...
<body>
	<div class="home<?php if ($_GET['n']) {echo(' hide');}?>">
		...
		<footer class="footer home-footer">
			<div class="inner">
				由 <a href="http://Anyway.FM" target="_blank">Anyway.FM</a> 的 <a href="https://dribbble.com/jjying" target="_blank">JJ Ying</a> 设计开发<span>•</span>源代码在 <a href="https://github.com/JJYing/Analytttics" target="_blank">GitHub</a> 上<span>•</span>所有指数仅供娱乐，请勿严肃对待<span>•</span><a href="index.php">for English</a>
			</div>
		</footer>
	</div>
	...
	<header class="<?php if ($_GET['n']=='') {echo('hide');}?>">
		...
		<nav class="v-align">
			<ul>
				<li><a href="http://iconmoon.com/blog2/analytttics-released/" target="_blank">关于这些指标</a></li>
				<li><a href="http://Anyway.FM" target="_blank">Anyway.FM 出品</a></li>
	...
	<footer class="<?php if ($_GET['n']=='') {echo('hide');}?>">
		<div class="inner">
			由 <a href="http://Anyway.FM" target="_blank">Anyway.FM</a> 主播 <a href="https://dribbble.com/jjying" target="_blank">JJ Ying</a> 设计开发，源代码在 <a href="https://github.com/JJYing/Analytttics" target="_blank">GitHub</a> 上，所有指数仅供娱乐，请勿严肃对待 ☻ <a href="mailto:hello@anyway.fm">联系我们</a>
		</div>
	</footer>
